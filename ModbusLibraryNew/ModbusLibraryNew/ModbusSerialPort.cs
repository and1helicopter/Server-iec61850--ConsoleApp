...
{
    public static class ModbusSerialPort
    {
        //public delegate void WaitMsSerialPort(int mscount);
        ...
        public static void ExtractData(out bool ExternalDataOk, out byte[] ExternalRxBuffer)
        {
            ...
            {
                ExternalDataOk = ModbusSerialPort.DataOk;
                ExternalRxBuffer = new byte[ModbusSerialPort.RxBuffer.Length];
                for (int i = 0; i < ModbusSerialPort.RxBuffer.Length; i++)
                {
                    ExternalRxBuffer[i] = ModbusSerialPort.RxBuffer[i];
                }
            }
            else
            {
